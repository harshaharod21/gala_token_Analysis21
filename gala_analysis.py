...
def overview_page():
    ...
    img=Image.open("/workspaces/gala_token_Analysis21/gala_logo.jpg")
    ...
    img=Image.open("/workspaces/gala_token_Analysis21/games.jpg")
    st.columns(3)[1].image(img)
    ...
    img=Image.open("/workspaces/gala_token_Analysis21/gala_music.jpg")
    st.columns(3)[1].image(img)
...
# Create a link to download the PDF
    pdf_link =create_download_link("Download PDF","/workspaces/gala_token_Analysis21/Gala_Music_Whitepaper.pdf")
...
# Display the link using st.markdown
    ...
    img=Image.open("/workspaces/gala_token_Analysis21/gala_film.jpg")
    st.columns(3)[1].image(img)
    st.markdown(
        """
        <style>
...
# Main part of the app
    ...
    img=Image.open("/workspaces/gala_token_Analysis21/Screenshot 2023-12-14 180544.png")
    ...
    img=Image.open("/workspaces/gala_token_Analysis21/top100token_holders.png")
    ...
    img=Image.open("/workspaces/gala_token_Analysis21/top gaming token by marketcap.png")
   ...
   #The tokenomics
    ...
    img=Image.open("/workspaces/gala_token_Analysis21/hhh.png")
    ...
    img=Image.open("/workspaces/gala_token_Analysis21/Screenshot 2023-12-16 120929.png")
...
def governance_mechanism_page():
    ...
    img=Image.open("/workspaces/gala_token_Analysis21/gala_nodes_governance.jpg")
    st.image(img, use_column_width=True)
...
def project_milestone_page():
    img=Image.open("/workspaces/gala_token_Analysis21/792774 (1).jpg")
    st.columns(3)[1].image(img)
    st.markdown(
        """
        <div style="text-align: center;">
...
def risk_evaluation_page():
    img=Image.open("/workspaces/gala_token_Analysis21/OIP (1).jpg")
    st.columns(3)[1].image(img)
    st.markdown(
        """
        <div style="text-align: center;">
    ...
    img=Image.open("/workspaces/gala_token_Analysis21/Screenshot 2023-12-16 102313.png")
    ...
    img=Image.open("/workspaces/gala_token_Analysis21/Screenshot 2023-12-15 123526.png")
    st.image(img,use_column_width=True)
...
def future_prospects_page():
    ...
    img=Image.open("/workspaces/gala_token_Analysis21/Screenshot 2023-12-16 104016.jpg")
    st.image(img,use_column_width=True)
